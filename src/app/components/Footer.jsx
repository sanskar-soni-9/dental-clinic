...
const Footer = () => {
  return (
    <footer className="bg-slate-800 pt-10 pb-2">
      <div className="grid grid-cols-4 gap-8 px-10">
        <div className="group space-y-6 gap-8 text-sm py-5">
        ...
        <div className="group flex flex-col gap-8 px-20 py-5">
          <div className="w-fit mx-auto">
            <h2 className="text-teal-500 cursor-default text-xl font-semibold">
              Quick Links
            </h2>
        ...
        <div className="group flex flex-col gap-8 py-5">
          <div className="w-fit mx-auto">
            <h2 className="text-teal-500 cursor-default text-xl font-semibold">
              Services
            </h2>
          ...
          <div className="flex text-teal-100 justify-between whitespace-nowrap">
            <div className="space-y-2">
              {services.map((service, index) => {
                if (index > (services.length - 1) / 2) return "";
                return <p className="hover:text-teal-200">{service.service}</p>;
              })}
            </div>
            <div className="space-y-2">
              {services.map((service, index) => {
        ...
        <div className="group flex flex-col gap-3 px-10i bg-teal-600 rounded-3xl pt-6 p-3 ml-10">
          <div className="w-fit mx-auto">
          ...
          <div className="text-teal-50 space-y-2 font-medium text-sm bg-slate-900 rounded-3xl py-4">
            {availableHours.map((day) => {
              return (
                <div className="flex justify-between hover:text-teal-500 px-4 py-2 rounded-full">
                  <p>{day.day}</p>
                  <p>{day.time}</p>
                </div>
              );
      ...
      <p className="text-center text-teal-600 text-xs">© Copyright 2023 | All Rights Reserved</p>
    </footer>
  );
};
